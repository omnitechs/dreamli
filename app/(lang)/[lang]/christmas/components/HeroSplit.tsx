...
export default function HeroSplit() {
  ...
  // If locale changes (fullText changes), restart typing from the beginning in the new language
  useEffect(() => {
    setTypedText('');
  ...
  }, [animationPhase, isMounted, fullText]);
          ...
          <div className="space-y-8">
            <div>
              <div className="inline-flex items-center gap-2 bg-[#8472DF]/10 border border-[#8472DF]/30 rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-sm font-medium text-[#8472DF]">{tc('hero.badgeNew')}</span>
                <span className="text-sm text-[#2E2E2E]">{tc('hero.badgeTry')}</span>
              </div>
              
              <h1 className="text-5xl lg:text-6xl font-bold text-[#2E2E2E] leading-tight mb-6">
                {tc('hero.title.before')} <span className="text-[#8472DF]">{tc('hero.title.highlight')}</span>
              </h1>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-6 text-sm text-[#2E2E2E]/70">
                <div className="flex items-center gap-2">
                  ...
                  <span>{tc('hero.bullets.noSkills')}</span>
                </div>
                <div className="flex items-center gap-2">
                  <i className="ri-check-line text-[#8472DF]"></i>
                  <span>{tc('hero.bullets.printsFrom')}</span>
                </div>
              </div>
            </div>
          </div>
