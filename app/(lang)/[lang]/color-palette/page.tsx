    ...
    <div className="min-h-screen bg-white py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">{t('title', { default: 'Color Palette Reference' })}</h1>
          <p className="text-lg text-gray-600">{t('subtitle', { default: 'Click any color to copy its hex code' })}</p>
        </div>
            ...
            >
              ...
              <div className="p-4">
                ...
                {copiedColor === color.hex && (
                  <p className="text-xs text-green-600 mt-2">{t('copied', { default: 'Copied!' })}</p>
                )}
              </div>
            </div>
          ))}
        ...
        <div className="bg-gray-50 rounded-xl p-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">{t('usage.title', { default: 'Color Usage Examples' })}</h2>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-800">{t('usage.primary', { default: 'Primary Colors' })}</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-800">{t('usage.accent', { default: 'Accent Colors' })}</h3>
              <div className="flex flex-wrap gap-2">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-800">{t('usage.background', { default: 'Background Colors' })}</h3>
              <div className="flex flex-wrap gap-2">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-800">{t('usage.combinations', { default: 'Color Combinations' })}</h3>
        ...
        <div className="mt-12 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">{t('quick.title', { default: 'Quick Reference' })}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-semibold text-gray-800 mb-3">{t('quick.tailwind', { default: 'Tailwind CSS Classes' })}</h3>
            ...
            <div>
              <h3 className="font-semibold text-gray-800 mb-3">{t('quick.css', { default: 'CSS Variables' })}</h3>
              <div className="space-y-2 text-sm font-mono bg-gray-50 p-4 rounded-lg">
