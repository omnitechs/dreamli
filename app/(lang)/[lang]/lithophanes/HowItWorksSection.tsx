...
export default async function HowItWorksSection() {
    ...
    const steps = [
        ...
        },
        {
            ...
            image:
                'https://readdy.ai/api/search-image?query=Two%20different%20lithophane%20styles%20side%20by%20side%2C%20one%20black%20and%20white%20monochrome%20lithophane%20showing%20classic%20portrait%20with%20beautiful%20depth%20and%20shadows%2C%20one%20full-color%20CMYK%20lithophane%20displaying%20vibrant%20colorful%20artwork%2C%20both%20illuminated%20with%20LED%20backlighting%20professional%20product%20photography%20setup&width=500&height=400&seq=style-choice-step&orientation=landscape'
        },
        {
            icon: 'ri-tools-line',
        ...
        },
        {
            ...
            image:
                'https://readdy.ai/api/search-image?query=Beautiful%20packaged%20lithophane%20being%20delivered%20to%20modern%20home%2C%20elegant%20gift%20packaging%20opened%20to%20reveal%20glowing%20lithophane%2C%20warm%20home%20interior%20setting%2C%20happy%20customer%20receiving%20their%20custom%20order%2C%20premium%20delivery%20experience%2C%20cozy%20living%20room%20atmosphere&width=500&height=400&seq=delivery-step&orientation=landscape'
        }
    ];
                        ...
                        >
                            <div className="relative mb-6">
                                ...
                                <div className="absolute -bottom-4 left-4 w-12 h-12 bg-gradient-to-br from-[#8472DF] to-[#93C4FF] rounded-full flex items-center justify-center shadow-lg">
                                    <i className={`${step.icon} text-white text-xl w-6 h-6 flex items-center justify-center`} />
                                </div>
                            </div>
