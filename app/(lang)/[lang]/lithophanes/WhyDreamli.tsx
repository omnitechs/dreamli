export default function WhyDreamli() {
  const features = [
    {
      icon: 'ri-printer-line',
      title: 'High-quality 3D printing',
      description: 'Built with precision and care using advanced 3D printing technology for exceptional detail and durability.',
      gradient: 'from-[#8472DF] to-[#93C4FF]'
    },
    {
      icon: 'ri-lightbulb-line',
      title: 'Even LED lighting',
      description: 'No dark spots, just pure glow. Our uniform LED backlighting system ensures perfect illumination across the entire lithophane.',
      gradient: 'from-[#93C4FF] to-[#ACEEF3]'
    },
    {
      icon: 'ri-heart-line',
      title: 'The perfect gift',
      description: 'Personal, meaningful, unforgettable. Transform any photo into a luminous keepsake that will be treasured forever.',
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[#2E2E2E]/80 max-w-3xl mx-auto">
              We combine cutting-edge technology with artisanal craftsmanship to create lithophanes that exceed expectations.
            </p>
          </div>

          <div className="grid lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-3">
          ...
          <div className="mt-16 bg-white rounded-3xl p-12 shadow-xl">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <div className="text-[#2E2E2E]/70">Days Delivery</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-[#ACEEF3] mb-2">4.9★</div>
                <div className="text-[#2E2E2E]/70">Customer Rating</div>
              </div>
              <div>
                <div className="text-3xl font-bold text-[#FFB067] mb-2">100%</div>
                <div className="text-[#2E2E2E]/70">Quality Guarantee</div>
              </div>
            </div>
          </div>
        </div>
