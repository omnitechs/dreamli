...
import { actionAddImages } from '../actions';
...
export function UploadCard({ projectId, headId, onStateUpdate }: UploadCardProps) {
  ...
  const handleFileUpload = async (files: FileList) => {
    ...
    setUploading(true);
    try {
      const updatedState = await actionAddImages(projectId, headId, formData);
