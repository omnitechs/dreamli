...
export default function CategoryHighlights() {
  const categories = [
    {
      title: "Creativity & Child Development",
      description: "Science-backed insights on nurturing creativity",
      icon: "ri-palette-line",
      gradient: "from-purple-500 to-pink-500",
      href: "https://blog.dreamli.nl/category/creativity-and-child-development/"
    },
    {
      title: "Parenting & Education Tips", 
      description: "Expert advice for modern parents",
      icon: "ri-parent-line",
      gradient: "from-blue-500 to-cyan-500",
      href: "https://blog.dreamli.nl/category/parenting-and-education-tips/"
    },
    {
      title: "Dreamli Stories & Behind the Scenes",
      description: "Real families, real transformations", 
      icon: "ri-camera-line",
