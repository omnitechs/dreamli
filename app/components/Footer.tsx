    ...
    <footer className="bg-gradient-to-br from-gray-50 to-gray-100 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          {/* Logo and tagline */}
          <div>
            <Link href="/home" className="cursor-pointer mb-4 inline-block">
              <img 
            ...
            <p className="text-gray-600 mb-6 max-w-md">
              We bring children's drawings to life as beautiful 3D models and preserve all special moments online forever.
            </p>
          ...
          {/* Collaboration Hub */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-purple-800">Collaboration Hub</h4>
        ...
        <div className="mt-8 flex justify-center">
          <div className="w-full max-w-md">
            ...
            <div className="trustpilot-widget" data-locale="en-US" data-template-id="56278e9abfbbba0bdcd568bc" data-businessunit-id="68a6edd70d777a86c73f9db9" data-style-height="52px" data-style-width="100%" data-token="3b0b1f1f-1479-4a43-a4a3-9869a48c81c3">
