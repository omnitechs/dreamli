...
export default function BlogHeroDE() {
  return (
    <section 
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6">
        <div className="text-center max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            ...
            <span className="text-purple-600">ein Kind nach dem anderen</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed max-w-3xl mx-auto">
            Erziehungstipps, kreative Spielideen und Geschichten von Familien, die mit Dreamli ihre Fantasie zum Leben erwecken.
          </p>
