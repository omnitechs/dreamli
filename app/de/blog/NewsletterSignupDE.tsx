...
export default function NewsletterSignupDE() {
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="p-8 lg:p-12">
              <div className="flex items-center mb-4">
                ...
                <span className="text-white/90 font-medium">Kostenloser Kreativitätsleitfaden</span>
              </div>
              
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
                Holen Sie sich unseren kostenlosen Leitfaden: 10 kreative Aktivitäten mit Ihren Kindern
              </h2>
              
              <p className="text-white/90 mb-6 text-lg">
                Bildschirmfreie Aktivitäten, die die Fantasie anregen und Familien näher zusammenbringen. 
                Außerdem erhalten Sie wöchentliche Tipps direkt in Ihr Postfach!
              </p>
              ...
              {!isSubmitted ? (
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    type="submit"
                    className="px-8 py-3 bg-white text-purple-600 font-semibold rounded-xl hover:bg-gray-50 transition-colors whitespace-nowrap cursor-pointer"
                  >
                    Jetzt beitreten
                  </button>
                </form>
                ...
                <div className="bg-white/20 rounded-xl p-4 flex items-center">
                  ...
                  <span className="text-white font-medium">Vielen Dank! Überprüfen Sie Ihre E-Mail für den kostenlosen Leitfaden.</span>
                </div>
              )}
