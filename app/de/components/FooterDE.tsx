...
export default function FooterDE() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!email) {
      setSubmitStatus('Bitte geben Sie Ihre E-Mail-Adresse ein.');
      return;
    }
    ...
    try {
      ...
      setSubmitStatus('Vielen Dank! Bitte überprüfen Sie Ihre E-Mail, um Ihr Abonnement zu bestätigen.');
      setEmail('');
    } catch (error) {
    ...
    <footer className="bg-gradient-to-br from-gray-50 to-gray-100 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          {/* Logo and tagline */}
          <div>
            <Link href="/de" className="cursor-pointer mb-4 inline-block">
              <img 
            ...
            <p className="text-gray-600 mb-6 max-w-md">
              Wir erwecken Kinderzeichnungen als schöne 3D-Modelle zum Leben und bewahren alle besonderen Momente online für immer auf.
            </p>
          ...
          {/* Company Information */}
          <div>
            <h3 className="font-bold text-gray-900 mb-4">Firmeninformationen</h3>
          ...
          {/* Collaboration Hub */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-purple-800">Kollaborations-Hub</h4>
            <ul className="space-y-2">
              <li>
                <Link href="/de/collaboration" className="text-gray-600 hover:text-purple-600 transition-colors">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm mb-4">
              Bleiben Sie über unsere neuesten Nachrichten auf dem Laufenden
            </p>

            <form 
              id="mailchimp-subscribe-de"
        ...
        <div className="mt-8 flex justify-center">
          <div className="w-full max-w-md">
            ...
            <div className="trustpilot-widget" data-locale="de-DE" data-template-id="56278e9abfbbba0bdcd568bc" data-businessunit-id="68a6edd70d777a86c73f9db9" data-style-height="52px" data-style-width="100%" data-token="3b0b1f1f-1479-4a43-a4a3-9869a48c81c3">
              <a href="https://www.trustpilot.com/review/dreamli.nl" target="_blank" rel="noopener">Trustpilot</a>
            </div>
            {/* End TrustBox widget */}
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-600 text-sm">
              2024 Dreamli. Alle Rechte vorbehalten.
            </p>
            <div className="flex space-x-6 text-sm text-gray-600">
              <Link href="/de/privacy" className="hover:text-purple-600 transition-colors cursor-pointer">
                Datenschutzrichtlinie
              </Link>
              <Link href="/de/terms" className="hover:text-purple-600 transition-colors cursor-pointer">
                Nutzungsbedingungen
              </Link>
