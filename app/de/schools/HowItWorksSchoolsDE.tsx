...
export default function HowItWorksSchoolsDE() {
  const steps = [
    {
      number: 1,
      title: "Format Wählen",
      description: "Wählen Sie aus Workshop-, Programm- oder Club-Optionen",
    ...
    },
    {
      number: 2,
      title: "Wir Liefern",
      description: "Komplette Kits kommen gebrauchsfertig an",
    ...
    {
      number: 3,
      title: "Sitzung Durchführen",
      description: "Einfacher Aufbau, klare Anweisungen, engagierte Schüler",
    ...
    {
      number: 4,
      title: "Zeigen & Behalten",
      description: "Schüler zeigen ihre Kreationen und nehmen sie mit nach Hause",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="inline-block bg-gradient-to-r from-orange-100 to-yellow-100 rounded-full px-6 py-3 mb-6">
            <span className="text-sm font-semibold text-orange-700">Wie Es Funktioniert</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Einfacher 4-Schritte-Prozess
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Von der Planung bis zur Fertigstellung — wir übernehmen die Komplexität, Sie genießen die Ergebnisse
          </p>
        </div>
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-3xl p-8 border border-white/50">
          <div className="grid md:grid-cols-3 gap-6 text-center">
            <div className="flex items-center justify-center space-x-3">
              ...
              <span className="text-gray-700 font-medium">6-12 Jahre</span>
            </div>
            ...
            <div className="flex items-center justify-center space-x-3">
              ...
              <span className="text-gray-700 font-medium">8-24 Schüler</span>
            </div>
            ...
            <div className="flex items-center justify-center space-x-3">
              ...
              <span className="text-gray-700 font-medium">Sichere Materialien</span>
            </div>
          </div>
        </div>
      </div>
