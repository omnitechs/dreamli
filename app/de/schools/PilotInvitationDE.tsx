...
interface PilotInvitationDEProps {
  onRequestPilot: () => void;
}

export default function PilotInvitationDE({ onRequestPilot }: PilotInvitationDEProps) {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center text-white">
          <h2 className="text-4xl md:text-5xl font-bold mb-8 leading-tight">
            Bereit, das kreative Lernen in Ihrer Schule zu transformieren?
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              ...
              <h3 className="font-bold text-lg mb-2">Probieren Sie eine Sitzung aus — keine Verpflichtung</h3>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              ...
              <h3 className="font-bold text-lg mb-2">15-minütige Demo</h3>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              ...
              <h3 className="font-bold text-lg mb-2">100% Zufriedenheitsgarantie</h3>
            </div>
          </div>
