...
export default function SafetyPracticalitiesDE() {
  const safetyFeatures = [
    "Wasserbasierte, ungiftige Farben",
    "Kindersichere Werkzeuge",
    "Auslaufsichere Behälter, Schürzen enthalten", 
    "Aufräumen in 5 Min"
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Sicher für Kinder, stressfrei für Lehrer.
          </h2>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg text-center">
                ...
                <div className="text-sm text-gray-600">Schulung erforderlich</div>
              </div>
              
              <div className="bg-white rounded-2xl p-6 shadow-lg text-center">
                <div className="text-2xl font-bold text-[#FFA726] mb-2">100%</div>
                <div className="text-sm text-gray-600">Sauberkeitsfrei</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 bg-white rounded-2xl p-4 shadow-xl border border-gray-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-bold text-gray-900 text-sm">CE Zertifiziert</p>
                  <p className="text-gray-600 text-xs">EU-Sicherheitsstandards</p>
                </div>
              </div>
            </div>
          </div>
