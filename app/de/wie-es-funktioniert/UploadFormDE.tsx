...
interface UploadFormDEProps {
  onClose: () => void;
  isNL?: boolean;
}

export default function UploadFormDE({ onClose, isNL = false }: UploadFormDEProps) {
  ...
  const t = {
    ...
    uploadText: 'Klicken Sie, um ein Bild oder Video hochzuladen',
    ...
    guaranteeTitle: 'Ihre Zufriedenheit Garantiert',
    guaranteeText: 'Wir warten auf Ihre Bestätigung vor dem Druck. Wenn Sie nach 3 Revisionen nicht zufrieden sind, geben wir Ihnen Ihr Geld zurück - ohne Fragen zu stellen.',
    orderButton: 'Jetzt Bestellen',
    processingButton: 'Bestellung wird verarbeitet...',
    redirectingButton: 'Weiterleitung zur Kasse...',
    successTitle: 'Anfrage Gesendet!',
    successMessage: 'Vielen Dank für Ihre Bestellung! Wir kontaktieren Sie innerhalb von 24 Stunden mit einer Vorschau und Preisen zur Bestätigung.',
    closeButton: 'Schließen',
    requiredError: 'Bitte füllen Sie alle Pflichtfelder aus.',
    fileSizeError: 'Dateigröße muss weniger als 50MB betragen.',
