...
export default function HowItWorksGifts() {
  const steps = [
    {
      number: 1,
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-3xl p-8 max-w-4xl mx-auto">
            <div className="flex items-center justify-center mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-900">Optional Painting Kit</h3>
            </div>
            <p className="text-lg text-gray-700 mb-6">
              Want more creativity? Choose the paintable option — you can color a figurine or even the fridge magnet together, turning the unboxing into a family activity.
            </p>
            <div className="inline-flex items-center space-x-2 bg-white rounded-full px-6 py-3 shadow-sm">
              ...
              <span className="text-gray-700 font-medium">Perfect for family bonding time</span>
            </div>
          </div>
        </div>
