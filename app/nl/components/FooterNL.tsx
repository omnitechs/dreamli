...
export default function FooterNL() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!email) {
      setSubmitStatus('Voer uw e-mailadres in.');
      return;
    }
    ...
    try {
      ...
      setSubmitStatus('Dank je wel! Controleer je e-mail om je abonnement te bevestigen.');
      setEmail('');
    } catch (error) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6 max-w-md">
              Wij brengen tekeningen van kinderen tot leven als prachtige 3D-modellen en bewaren alle speciale momenten voor altijd online.
            </p>
          ...
          {/* Company Information */}
          <div>
            <h3 className="font-bold text-gray-900 mb-4">Bedrijfsinformatie</h3>
          ...
          {/* Collaboration Hub */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-purple-800">Samenwerking Hub</h4>
            ...
            >
              ...
              {submitStatus && (
                <div className={`text-xs p-2 rounded ${ 
                  submitStatus.includes('Dank je wel') 
        ...
        <div className="mt-8 flex justify-center">
          <div className="w-full max-w-md">
            ...
            <div className="trustpilot-widget" data-locale="nl-NL" data-template-id="56278e9abfbbba0bdcd568bc" data-businessunit-id="68a6edd70d777a86c73f9db9" data-style-height="52px" data-style-width="100%" data-token="3b0b1f1f-1479-4a43-a4a3-9869a48c81c3">
