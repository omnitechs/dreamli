...
export default function GuaranteeSectionNL() {
  return (
    <section className="py-24 bg-[#F0F9FF]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-8">
          Geen risico voor scholen.
        </h2>
        ...
        <div className="bg-white rounded-3xl p-12 shadow-xl border border-blue-100">
          ...
          <p className="text-xl text-gray-700 leading-relaxed max-w-2xl mx-auto">
            Als je niet tevreden bent na de eerste uitvoering, betalen we je terug — geen vragen gesteld.
          </p>
          ...
          <div className="mt-8 inline-flex items-center space-x-3 bg-green-50 rounded-full px-6 py-3 border border-green-200">
            ...
            <span className="text-green-700 font-semibold">100% Tevredenheidsgarantie</span>
          </div>
        </div>
      </div>
    </section>
