...
interface SchoolsTopBannerNLProps {
  onRequestPilot: () => void;
}

export default function SchoolsTopBannerNL({ onRequestPilot }: SchoolsTopBannerNLProps) {
        ...
        <div className="flex items-center justify-between">
          <div className="flex-1">
            <p className="text-lg font-bold">
              Proefplekken beschikbaar voor nieuwe schooljaar — Risicovrije pilot voor Groninger scholen & BSO. Beperkte plaatsen.
            </p>
          </div>
