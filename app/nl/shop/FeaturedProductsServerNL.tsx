...
export default async function FeaturedProductsServerNL() {
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-4" style={{ color: '#2E2E2E' }}>Uitgelichte Producten</h2>
            <p style={{ color: '#2E2E2E' }}>Er zijn momenteel geen uitgelichte producten beschikbaar — kom binnenkort terug!</p>
          </div>
        </div>
      </section>
    );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="max-w-2xl mx-auto" style={{ color: '#2E2E2E' }}>
            Ontdek onze handgeselecteerde collectie van creatief speelgoed en kits
          </p>
        </div>
