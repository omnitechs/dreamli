...
export default function UploadFormNL({ onClose, type, pricingField }: UploadFormProps) {
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          ...
          {submitStatus !== 'success' ? (
            <form id="dreamli-upload-nl" onSubmit={handleSubmit} className="space-y-5">
              <div>
