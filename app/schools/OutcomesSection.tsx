...
export default function OutcomesSection() {
  const outcomes = [
    {
      title: "Focus",
      improvement: "+14–17% attention",
      description: "Sustained attention and concentration during activities",
      icon: "ri-focus-3-fill",
      color: "from-blue-500 to-indigo-500"
    },
    {
      title: "Self-esteem", 
      improvement: "~32% boost in confidence",
      description: "Confidence in creative abilities and problem-solving",
      icon: "ri-medal-fill",
      color: "from-green-500 to-emerald-500"
    },
    {
      title: "Resilience",
      improvement: "Problem-solving mindset", 
      description: "Persistence through challenges and creative thinking",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Not just fun — measurable outcomes.
          </h2>
        </div>
