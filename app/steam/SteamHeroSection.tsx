...
import SteamScatteredCardGallery from './SteamScatteredCardGallery';

interface SteamHeroSectionProps {
  onOpenUploadForm?: () => void;
}

export default function SteamHeroSection({ onOpenUploadForm }: SteamHeroSectionProps) {
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-6 pt-6">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-xs">Child-friendly paints</p>
                  </div>
                </div>
                <div className="flex items-center space-x-2">
