        ...
        <div className="bg-gradient-to-r from-[#FFB067] to-[#ACEEF3] rounded-3xl p-12 text-center">
          <div className="space-y-6">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Explore amazing 3D creations from our community. See what others have designed and get inspired for your next project!
            </p>
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="grid md:grid-cols-4 gap-8 pt-12 max-w-4xl mx-auto">
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="text-white font-semibold">Made in Groningen</div>
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="text-white font-semibold">Biodegradable PLA</div>
                <div className="text-white/80 text-sm">🌱</div>
              </div>
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <div className="text-white font-semibold">Fast Shipping</div>
                <div className="text-white/80 text-sm">⚡</div>
              </div>
            </div>
          </div>
